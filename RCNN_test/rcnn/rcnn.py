...
def parse_opt():
    ...
    parser.add_argument("--config-file", default="/GPFS/data/zxlei/Sketch/InteractiveSketch/sketchesVQA/SketchesVQA/RCNN_test/rcnn/configs/d2/test-d2-r101.yaml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
